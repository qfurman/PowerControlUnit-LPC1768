...
typedef union{
  ...
  //проектно орієнтований розподіл пінів P0
  struct
  {
    unsigned int  TXD3    : 1;
    unsigned int  RXD3    : 1;
    ...
    unsigned int  P4      : 1;
    unsigned int  P5      : 1;
    unsigned int  SSEL1   : 1;
    unsigned int  SCK1    : 1;
    unsigned int  MISO1   : 1;
    unsigned int  MOSI1   : 1;
    unsigned int  COOL    : 1;
    unsigned int  MHZ25   : 1;
    unsigned int  P12     : 1;
    unsigned int  P13     : 1;
    unsigned int  P14     : 1;
    unsigned int  SCK0    : 1;
    unsigned int  SSEL0   : 1;
    unsigned int  MISO0   : 1;
    unsigned int  MOSI0   : 1;
    unsigned int  L       : 4;
    unsigned int  R_SCR   : 1;
    unsigned int  I_SCR   : 1;
    unsigned int  R380    : 1;
    unsigned int  DAC10V  : 1;
    unsigned int  SDA     : 1;
    unsigned int  SCL     : 1;
    unsigned int  RELE1   : 1;
    unsigned int  LL3     : 1;
    unsigned int  P31     : 1;
  };
  //--кінець проектно орієнтований розподіл пінів
  struct
  {
    union
    {
...
typedef union{
  ...
  //проектно орієнтований розподіл пінів P1
  struct
  {
    unsigned int  ENET_TXD0    : 1;
    unsigned int  ENET_TXD1    : 1;
    unsigned int  P2           : 1;
    unsigned int  P3           : 1;
    unsigned int  ENET_TX_EN   : 1;
    unsigned int  P5           : 1;
    unsigned int  P6           : 1;
    unsigned int  P7           : 1;
    unsigned int  ENET_CRS     : 1;
    unsigned int  ENET_RXD0    : 1;
    unsigned int  ENET_RXD1    : 1;
    unsigned int  P11          : 1;
    unsigned int  P12          : 1;
    unsigned int  P13          : 1;
    unsigned int  ENET_RX_ER   : 1;
    unsigned int  ENET_REF_CLK : 1;
    unsigned int  ENET_MDC     : 1;
    unsigned int  ENET_MDIO    : 1;
    unsigned int  LL2          : 1;
    unsigned int  LL1          : 1;
    unsigned int  ENCA         : 1;
    unsigned int  PWRS2        : 1;//ENCS
    unsigned int  BL_REF       : 1;
    unsigned int  ENCB         : 1;
    unsigned int  LL0          : 1;
    unsigned int  V0           : 1;
    unsigned int  KL           : 4;
    unsigned int  AD0_6        : 1;
    unsigned int  V0_10        : 1;
  };
  //--кінець проектно орієнтований розподіл пінів
  struct
  {
...
typedef union{
  ...
  //проектно орієнтований розподіл пінів P2
  struct
  {
    unsigned int  TXD1    : 1;
    unsigned int  RXD1    : 1;
    unsigned int  PWM1_3  : 1;
    unsigned int  PWRS1   : 1;
    unsigned int  PWRS    : 1;
    unsigned int  Rw      : 1;
    unsigned int  LCDS    : 1;
    unsigned int  RTS1    : 1;
...
typedef union{
  ...
  //проектно орієнтований розподіл пінів P3
  struct
  {
    unsigned int          :25;
    unsigned int  BUZ     : 1;
    unsigned int  nLCD_OE : 1;
    unsigned int          : 5;            
  };
  //--кінець проектно орієнтований розподіл пінів  
  struct
...
typedef union{
  ...
  //проектно орієнтований розподіл пінів P4
  struct
  {
    unsigned int          :28;
    unsigned int P28      : 1;
